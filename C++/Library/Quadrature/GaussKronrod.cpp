                            ...
                            double& resasc) const
{
    ...
    const double f_center        = function(center);
    ...
    for (int j = 0; j < (n - 1) / 2; j++) {
        ...
        const double fval1    = function(center - abscissa);
        const double fval2    = function(center + abscissa);
    ...
    double result_asc = wgk[n - 1] * std::fabs(f_center - mean);
    
    for (int j = 0; j < n - 1; j++) {
        result_asc += wgk[j] * (std::fabs(fv1[j] - mean) +
                                std::fabs(fv2[j] - mean));
    }
...
double GaussKronrod::rescale_error(double err,
                                   ...
                                   const double result_asc) const
{
    ...
    if (result_asc != 0 && err != 0) {
        const double scale = std::pow((200 * err / result_asc), 1.5);
...
const double GaussKronrod15::wg[4] =
{
...
const double GaussKronrod15::wgk[8] =
{
...
void GaussKronrod15::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(8, xgk, wg, wgk, function, a, b, fv1, fv2,
...
const double GaussKronrod21::wg[5] =
{
...
const double GaussKronrod21::wgk[11] =
{
...
void GaussKronrod21::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(11, xgk, wg, wgk, function, a, b, fv1, fv2,
             result, abserr, resabs, resasc);
}
...
const double GaussKronrod31::wg[8] =
{
...
const double GaussKronrod31::wgk[16] =
{
...
void GaussKronrod31::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(16, xgk, wg, wgk, function, a, b, fv1, fv2,
             result, abserr, resabs, resasc);
}
...
const double GaussKronrod41::wg[11] =
{
...
const double GaussKronrod41::wgk[21] =
{
...
void GaussKronrod41::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(21, xgk, wg, wgk, function, a, b, fv1, fv2,
             result, abserr, resabs, resasc);
}
...
const double GaussKronrod51::wg[13] =
{
...
const double GaussKronrod51::wgk[26] =
{
...
void GaussKronrod51::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(26, xgk, wg, wgk, function, a, b, fv1, fv2,
             result, abserr, resabs, resasc);
}
...
const double GaussKronrod61::wg[15] =
{
...
const double GaussKronrod61::wgk[31] =
{
...
void GaussKronrod61::operator()(Function function,
                                const double a,
                                const double b,
                                double& result,
                                double& abserr,
                                ...
                                double& resasc)
{
    ...
    evaluate(31, xgk, wg, wgk, function, a, b, fv1, fv2,
             result, abserr, resabs, resasc);
}
