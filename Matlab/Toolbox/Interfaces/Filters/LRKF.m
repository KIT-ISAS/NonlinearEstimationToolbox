...
classdef LRKF < KF & SampleBasedGaussianFilter
    ...
    methods (Access = 'protected')
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncArbitraryNoise(obj, iterNum, iterStateMean, iterStateCov, iterStateCovSqrt, ...
                                                                measModel, dimNoise, dimMeas, numMeas, noiseMean, noiseCovSqrt)
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncAdditiveNoise(obj, iterNum, iterStateMean, iterStateCov, iterStateCovSqrt, ...
                                                               measModel, dimMeas, numMeas, noiseMean, noiseCov)
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncMixedNoise(obj, iterNum, iterStateMean, iterStateCov, iterStateCovSqrt, ...
