...
classdef LRKF < KF & SampleBasedJointlyGaussianPrediction
    ...
    methods (Access = 'protected')
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncArbitraryNoise(obj, priorMean, priorCov, iterNum, iterMean, iterCov, iterCovSqrt, ...
                                                                measModel, dimNoise, dimMeas, numMeas, noiseMean, noiseCovSqrt)
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncAdditiveNoise(obj, priorMean, priorCov, iterNum, iterMean, iterCov, iterCovSqrt, ...
                                                               measModel, dimMeas, numMeas, noiseMean, noiseCov)
        ...
        function [measMean, measCov, ...
                  stateMeasCrossCov] = momentFuncMixedNoise(obj, priorMean, priorCov, iterNum, iterMean, iterCov, iterCovSqrt, ...
