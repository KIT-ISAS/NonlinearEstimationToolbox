...
classdef CRUF < SampleBasedRecursiveUpdateFilter & CubatureLinearGaussianFilter
    % The fifth-degree cubature recursive update filter (CRUF).
    %
    % CRUF Methods:
    %   CRUF                        - Class constructor.
