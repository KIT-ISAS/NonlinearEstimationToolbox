...
classdef S2KF < LRKF
    ...
    methods (Access = 'protected')
        % We overwrite the moment computation for the state prediction in
        % order to exploit the fact that all samples used by the S²KF are
        % equally weighted. This reduces runtime and has numerical benefits.
