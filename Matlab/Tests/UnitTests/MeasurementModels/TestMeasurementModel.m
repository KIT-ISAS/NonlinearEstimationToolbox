...
classdef TestMeasurementModel < matlab.unittest.TestCase
    ...
    methods (Test)
        function testSimulateDefaultNumMeasurements(obj)
            ...
            detMeas = measModel.measMatrix * TestUtilsMeasurementModel.initMean;
            
            measurements = measModel.simulate(TestUtilsMeasurementModel.initMean);
        ...
        function testSimulate(obj)
            ...
            measurements = measModel.simulate(TestUtilsMeasurementModel.initMean, n);
